...
#When you learn about if statements and loops, you will realise that indentation is necesarry

#If you want to write something to show in the console/output, you can use the print() operator:
print("Hello World!")
#the text has to be in quotes to show it is text

#the print operator can be used on numbers too and many other datatypes(which will be covered later)
print(10)
